...
# 6. HTTP SMS API (Primary - used by send_otp_sms in views.py)
HTTPSMS_API_KEY = os.getenv('HTTPSMS_API_KEY')
HTTPSMS_FROM_NUMBER = os.getenv('HTTPSMS_FROM_NUMBER')

# 6b. Semaphore SMS API (backup)
SEMAPHORE_API_KEY = os.getenv('SEMAPHORE_API_KEY')
SEMAPHORE_SENDER_NAME = os.getenv('SEMAPHORE_SENDER_NAME', 'CATC Portal')

# 6c. iProg SMS API (backup)
...
TRACKINGMORE_TRACKING_PAGE_URL = os.getenv(
    'TRACKINGMORE_TRACKING_PAGE_URL',
    'https://kyoukoisbigsad8t.trackingmore.org/?page=tracking-page'
)
